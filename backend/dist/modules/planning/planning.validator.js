export function checkTimeOverlap(window1, window2) {
    return window1.startTime < window2.endTime && window1.endTime > window2.startTime;
}
export function validateStudyPlanCalendar(proposedBlocks, existingClasses) {
    const collisions = [];
...
//# sourceMappingURL=planning.validator.js.map